            ...
            <Modal title={this.props.id
                ...
                <Form>
                    <Form.Item label="用户名：" validateStatus={errorStatus('username')} help={help('username')}>
                        <Input value={formData.username} placeholder="填写字母、下划线、数字" onChange={this.setValue.bind(this, 'username')}/>
                    </Form.Item>
                    <Row>
                        <Col span="11">
                        ...
                        <Col span="11" offset="2">
                            <Form.Item label="状态：" validateStatus={errorStatus('is_delete')} help={help('is_delete')}>
                                <RadioGroup value={formData.is_delete
                                    ? 1
                                    : 0} onChange={this.setValue.bind(this, 'is_delete')}>
                    ...
                    <Form.Item label="Key：" validateStatus={errorStatus('key')} help={help('key')}>
                        <Input type="textarea" rows="4" value={formData.key} onChange={this.setValue.bind(this, 'key')}/>
                    </Form.Item>
                </Form>
            </Modal>
        )
