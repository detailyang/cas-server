...
import Antd, {Modal, Tooltip, Icon, Checkbox, Form, Input, Radio, Row, Col} from 'antd'
        ...
        return (
            <Modal
                ...
                <Form>
                    ...
                    <Form.Item
                        label={<span>admin <Tooltip title="具有admin权限"><Icon type="question-circle-o" /></Tooltip>: </span>}
                        validateStatus={errorStatus('is_admin')} help={help('is_admin')}>
                        <label>
                            <Checkbox
                                checked={formData.is_admin ? 1 : 0}
